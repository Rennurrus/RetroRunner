...
public class GLSurfaceView20 extends GLSurfaceView {
    ...
    public GLSurfaceView20(Context context, ResolutionStrategy resolutionStrategy2, int targetGLESVersion2) {
        super(context);
    ...
    static class ContextFactory implements GLSurfaceView.EGLContextFactory {
        ...
        public EGLContext createContext(EGL10 egl, EGLDisplay display, EGLConfig eglConfig) {
            ...
            EGLContext context = egl.eglCreateContext(display, eglConfig, EGL10.EGL_NO_CONTEXT, new int[]{EGL_CONTEXT_CLIENT_VERSION, GLSurfaceView20.targetGLESVersion, 12344});
            if ((!GLSurfaceView20.checkEglError("After eglCreateContext " + GLSurfaceView20.targetGLESVersion, egl) || context == null) && GLSurfaceView20.targetGLESVersion > 2) {
