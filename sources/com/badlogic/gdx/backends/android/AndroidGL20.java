...
public class AndroidGL20 implements GL20 {
    ...
    public void glBindBuffer(int target, int buffer2) {
        GLES20.glBindBuffer(target, buffer2);
    }
    ...
    public void glDeleteBuffer(int buffer2) {
        int[] iArr = this.ints;
        iArr[0] = buffer2;
    ...
    public String glGetActiveAttrib(int program, int index, IntBuffer size, Buffer type) {
        this.ints[0] = 0;
        this.ints2[0] = size.get(0);
        this.ints3[0] = ((IntBuffer) type).get(0);
    ...
    public boolean glIsBuffer(int buffer2) {
        return GLES20.glIsBuffer(buffer2);
    }
