...
public abstract class PrimitiveSpawnShapeValue extends SpawnShapeValue {
    ...
    public void write(Json json) {
        super.write(json);
        json.writeValue("spawnWidthValue", (Object) this.spawnWidthValue);
        json.writeValue("spawnHeightValue", (Object) this.spawnHeightValue);
        json.writeValue("spawnDepthValue", (Object) this.spawnDepthValue);
        json.writeValue("edges", (Object) Boolean.valueOf(this.edges));
    }
