...
public class DynamicsInfluencer extends Influencer {
    ...
    public DynamicsInfluencer(DynamicsModifier... velocities2) {
        this.velocities = new Array<>(true, velocities2.length, DynamicsModifier.class);
        for (DynamicsModifier value : velocities2) {
    ...
    public void activateParticles(int startIndex, int count) {
        ...
        if (this.has2dAngularVelocity != 0) {
        ...
        if (this.has2dAngularVelocity != 0) {
            ...
            while (i2 < this.controller.particles.size) {
                ...
                if (rotation != 0.0f) {
                    ...
                    this.rotationChannel.data[offset2 + 0] = (currentCosine * cosBeta) - (currentSine * sinBeta);
                    this.rotationChannel.data[offset2 + 1] = (currentSine * cosBeta) + (currentCosine * sinBeta);
                }
                i2++;
