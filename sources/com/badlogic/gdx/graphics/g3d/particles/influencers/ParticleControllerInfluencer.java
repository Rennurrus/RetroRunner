...
public abstract class ParticleControllerInfluencer extends Influencer {
    ...
    public ParticleControllerInfluencer(ParticleController... templates2) {
        this.templates = new Array<>((T[]) templates2);
    }
    ...
    public void save(AssetManager manager, ResourceData resources) {
        ...
        for (int i = 0; i < effects.size && controllers.size > 0; i++) {
            ...
            while (iterator.hasNext()) {
                int indexOf = effectControllers.indexOf(iterator.next(), true);
                int index = indexOf;
                if (indexOf > -1) {
                    if (indices == null) {
