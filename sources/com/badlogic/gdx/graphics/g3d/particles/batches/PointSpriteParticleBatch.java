...
public class PointSpriteParticleBatch extends BufferedParticleBatch<PointSpriteControllerRenderData> {
    ...
    public PointSpriteParticleBatch(int capacity, ParticleShader.Config shaderConfig) {
        ...
        renderable2.shader = new ParticleShader(renderable2, shaderConfig);
    ...
    public void flush(int[] offsets) {
        ...
        while (it.hasNext()) {
            ...
            Iterator it2 = it;
            PointSpriteControllerRenderData pointSpriteControllerRenderData = data;
            ParallelArray.FloatChannel floatChannel = positionChannel;
        }
