...
public class Decal {
    ...
    public Decal(DecalMaterial material2) {
        this.vertices = new float[24];
        this.position = new Vector3();
        this.rotation = new Quaternion();
        this.scale = new Vector2(1.0f, 1.0f);
    ...
    public void setColor(float r, float g, float b, float a) {
        ...
        float color2 = NumberUtils.intToFloatColor(((int) (255.0f * r)) | (((int) (a * 255.0f)) << 24) | (((int) (b * 255.0f)) << 16) | (((int) (g * 255.0f)) << 8));
    ...
    public void setPackedColor(float color2) {
        Color.abgr8888ToColor(this.color, color2);
        float[] fArr = this.vertices;
        fArr[3] = color2;
        fArr[9] = color2;
        fArr[15] = color2;
    ...
    public void setMaterial(DecalMaterial material2) {
        this.material = material2;
    }
    ...
    public static Decal newDecal(float width, float height, TextureRegion textureRegion, int srcBlendFactor, int dstBlendFactor, DecalMaterial material2) {
        Decal decal = new Decal(material2);
        decal.setTextureRegion(textureRegion);
        decal.setBlending(srcBlendFactor, dstBlendFactor);
        Vector2 vector2 = decal.dimensions;
        vector2.x = width;
