...
public interface MeshPartBuilder {
    ...
    public static class VertexInfo implements Pool.Poolable {
        ...
        public VertexInfo set(Vector3 pos, Vector3 nor, Color col, Vector2 uv2) {
            reset();
            boolean z = true;
        ...
        public VertexInfo set(VertexInfo other) {
            if (other == null) {
                return set((Vector3) null, (Vector3) null, (Color) null, (Vector2) null);
            }
        ...
        public VertexInfo setUV(Vector2 uv2) {
            this.hasUV = uv2 != null;
            if (this.hasUV) {
                this.uv.set(uv2);
            }
