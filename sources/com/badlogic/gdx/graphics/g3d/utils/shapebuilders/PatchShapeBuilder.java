...
public class PatchShapeBuilder extends BaseShapeBuilder {
    ...
    public static void build(MeshPartBuilder builder, Vector3 corner00, Vector3 corner10, Vector3 corner11, Vector3 corner01, Vector3 normal, int divisionsU, int divisionsV) {
        ...
        build(builder, vertTmp1.set(corner00, vector3, (Color) null, (Vector2) null).setUV(0.0f, 1.0f), vertTmp2.set(corner10, vector3, (Color) null, (Vector2) null).setUV(1.0f, 1.0f), vertTmp3.set(corner11, vector3, (Color) null, (Vector2) null).setUV(1.0f, 0.0f), vertTmp4.set(corner01, vector3, (Color) null, (Vector2) null).setUV(0.0f, 0.0f), divisionsU, divisionsV);
    }
    ...
    public static void build(MeshPartBuilder builder, float x00, float y00, float z00, float x10, float y10, float z10, float x11, float y11, float z11, float x01, float y01, float z01, float normalX, float normalY, float normalZ, int divisionsU, int divisionsV) {
        ...
        float f2 = normalY;
        float f3 = normalZ;
        build(builder, vertTmp1.set((MeshPartBuilder.VertexInfo) null).setPos(x00, y00, z00).setNor(f, f2, f3).setUV(0.0f, 1.0f), vertTmp2.set((MeshPartBuilder.VertexInfo) null).setPos(x10, y10, z10).setNor(f, f2, f3).setUV(1.0f, 1.0f), vertTmp3.set((MeshPartBuilder.VertexInfo) null).setPos(x11, y11, z11).setNor(f, f2, f3).setUV(1.0f, 0.0f), vertTmp4.set((MeshPartBuilder.VertexInfo) null).setPos(x01, y01, z01).setNor(f, f2, f3).setUV(0.0f, 0.0f), divisionsU, divisionsV);
    }
}
