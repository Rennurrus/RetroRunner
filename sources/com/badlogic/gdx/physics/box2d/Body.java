...
public class Body {
    ...
    public void setTransform(Vector2 position2, float angle) {
        jniSetTransform(this.addr, position2.x, position2.y, angle);
    }
    ...
    public Vector2 getWorldPoint(Vector2 localPoint3) {
        jniGetWorldPoint(this.addr, localPoint3.x, localPoint3.y, this.tmp);
    ...
    public Vector2 getWorldVector(Vector2 localVector2) {
        jniGetWorldVector(this.addr, localVector2.x, localVector2.y, this.tmp);
    ...
    public Vector2 getLocalVector(Vector2 worldVector2) {
        jniGetLocalVector(this.addr, worldVector2.x, worldVector2.y, this.tmp);
    ...
    public Vector2 getLinearVelocityFromLocalPoint(Vector2 localPoint3) {
        jniGetLinearVelocityFromLocalPoint(this.addr, localPoint3.x, localPoint3.y, this.tmp);
