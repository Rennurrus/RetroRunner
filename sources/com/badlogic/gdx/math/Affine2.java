...
public final class Affine2 implements Serializable {
    ...
    public Affine2 inv() {
        ...
        if (det != 0.0f) {
            ...
            this.m12 = invDet * ((f5 * f4) - (this.m00 * f2));
            return this;
        }
    ...
    public Affine2 mul(Affine2 other) {
        ...
        this.m01 = tmp01;
        this.m02 = tmp02;
        this.m10 = (f2 * f9) + (f4 * f10);
        this.m11 = (f5 * f9) + (f6 * f10);
        this.m12 = (f9 * f7) + (f10 * f8) + this.m12;
        return this;
    }
    ...
    public Affine2 preMul(Affine2 other) {
        ...
        this.m10 = (f2 * f9) + (f4 * f10);
        this.m11 = (f5 * f9) + (f6 * f10);
        this.m12 = (f9 * f7) + (f10 * f8) + other.m12;
        return this;
    }
    ...
    public Affine2 rotate(float degrees) {
        ...
        this.m00 = tmp00;
        this.m01 = tmp01;
        this.m10 = (f3 * cos) + (f4 * sin);
        this.m11 = (f3 * (-sin)) + (f4 * cos);
        return this;
    }
    ...
    public Affine2 preRotate(float degrees) {
        ...
        float f5 = this.m02;
        float f6 = this.m12;
        this.m00 = (cos * f) - (sin * f2);
        this.m01 = (cos * f3) - (sin * f4);
        this.m02 = (cos * f5) - (sin * f6);
        this.m10 = (f * sin) + (f2 * cos);
        this.m11 = (f3 * sin) + (f4 * cos);
        this.m12 = (f5 * sin) + (f6 * cos);
        return this;
    }
    ...
    public Affine2 shear(float shearX, float shearY) {
        float f = this.m00;
        float f2 = this.m01;
        this.m00 = (shearY * f2) + f;
        this.m01 = f2 + (f * shearX);
        float f3 = this.m10;
        float f4 = this.m11;
        this.m10 = (shearY * f4) + f3;
        this.m11 = f4 + (f3 * shearX);
        return this;
    }
    ...
    public Affine2 preShear(float shearX, float shearY) {
        ...
        float f5 = this.m02;
        float f6 = this.m12;
        this.m00 = (shearX * f2) + f;
        this.m01 = (shearX * f4) + f3;
        this.m02 = (shearX * f6) + f5;
        this.m10 = f2 + (f * shearY);
        this.m11 = f4 + (f3 * shearY);
        this.m12 = f6 + (f5 * shearY);
        return this;
    }
