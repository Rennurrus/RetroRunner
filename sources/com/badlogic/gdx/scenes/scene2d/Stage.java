...
public class Stage extends InputAdapter implements Disposable {
    ...
    public boolean touchDragged(int screenX, int screenY, int pointer) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (focus.pointer == pointer && touchFocuses2.contains(focus, true)) {
    ...
    public void cancelTouchFocus(Actor listenerActor) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (focus.listenerActor == listenerActor && touchFocuses2.removeValue(focus, true)) {
                event.setTarget(focus.target);
                event.setListenerActor(focus.listenerActor);
    ...
    public void cancelTouchFocus() {
        cancelTouchFocusExcept((EventListener) null, (Actor) null);
    }
    ...
    public void cancelTouchFocusExcept(EventListener exceptListener, Actor exceptActor) {
        ...
        for (int i = 0; i < n; i++) {
            TouchFocus focus = items[i];
            if (!(focus.listener == exceptListener && focus.listenerActor == exceptActor) && touchFocuses2.removeValue(focus, true)) {
                event.setTarget(focus.target);
                event.setListenerActor(focus.listenerActor);
                event.setPointer(focus.pointer);
                event.setButton(focus.button);
    ...
    public void unfocusAll() {
        setScrollFocus((Actor) null);
        setKeyboardFocus((Actor) null);
        cancelTouchFocus();
    }
    ...
    public void setRoot(Group root2) {
        if (root2.parent != null) {
            root2.parent.removeActor(root2, false);
        }
        this.root = root2;
        root2.setParent((Group) null);
        root2.setStage(this);
    }
    ...
    public void setActionsRequestRendering(boolean actionsRequestRendering2) {
        this.actionsRequestRendering = actionsRequestRendering2;
    }
    ...
    public void setDebugInvisible(boolean debugInvisible2) {
        this.debugInvisible = debugInvisible2;
    }

    public void setDebugAll(boolean debugAll2) {
        if (this.debugAll != debugAll2) {
            this.debugAll = debugAll2;
            if (debugAll2) {
                debug = true;
            } else {
    ...
    public void setDebugUnderMouse(boolean debugUnderMouse2) {
        if (this.debugUnderMouse != debugUnderMouse2) {
            this.debugUnderMouse = debugUnderMouse2;
            if (debugUnderMouse2) {
                debug = true;
            } else {
                this.root.setDebug(false, true);
    ...
    public void setDebugParentUnderMouse(boolean debugParentUnderMouse2) {
        if (this.debugParentUnderMouse != debugParentUnderMouse2) {
            this.debugParentUnderMouse = debugParentUnderMouse2;
            if (debugParentUnderMouse2) {
                debug = true;
            } else {
                this.root.setDebug(false, true);
            }
    ...
    public void setDebugTableUnderMouse(Table.Debug debugTableUnderMouse2) {
        if (debugTableUnderMouse2 == null) {
            debugTableUnderMouse2 = Table.Debug.none;
        }
        if (this.debugTableUnderMouse != debugTableUnderMouse2) {
            this.debugTableUnderMouse = debugTableUnderMouse2;
            if (debugTableUnderMouse2 != Table.Debug.none) {
                debug = true;
            } else {
                this.root.setDebug(false, true);
            }
    ...
    public void setDebugTableUnderMouse(boolean debugTableUnderMouse2) {
        setDebugTableUnderMouse(debugTableUnderMouse2 ? Table.Debug.all : Table.Debug.none);
    }
    ...
    public boolean isInsideViewport(int screenX, int screenY) {
        ...
        if (screenX < x0 || screenX >= x1 || screenY2 < y0 || screenY2 >= y1) {
            return false;
        }
        return true;
    }
