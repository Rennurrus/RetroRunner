...
public class ShortArray {
    ...
    public ShortArray(boolean ordered2, int capacity) {
    ...
    public ShortArray(boolean ordered2, short[] array, int startIndex, int count) {
        this(ordered2, count);
        this.size = count;
